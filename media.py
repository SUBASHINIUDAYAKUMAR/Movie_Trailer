...
class Movie ( ) :
    ...
    def __init__ (self, movie_title, movie_storyline, poster_image, trailer_youtube) : # When __init__ is called all arguments in parenthese ( ) gets called and populated with appropriate values.
